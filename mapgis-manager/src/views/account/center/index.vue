      ...
      <a-col :md="24" :lg="7">
        <a-card :bordered="false">
          ...
          <div class="account-center-detail">
            <p><a-icon class="info" type="phone" />{{ user.phonenumber }}</p>
            <p><a-icon class="info" type="mail" />{{ user.email }}</p>
            <p v-if="user.dept">
              <a-icon class="info" type="apartment" />{{ user.dept.deptName }} /
              {{ postGroup }}
            </p>
            <p><a-icon class="info" type="calendar" />{{ user.createTime }}</p>
          </div>
          <a-divider />
