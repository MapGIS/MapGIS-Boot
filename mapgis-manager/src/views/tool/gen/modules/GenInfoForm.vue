        ...
        <a-col :span="12">
          <a-form-model-item prop="packageName">
            <span slot="label">
              生成包路径
              <a-tooltip>
                <template slot="title"> 生成在哪个java包下，例如 com.zondy.mapgis.system </template>
        ...
        <a-col :span="12">
          <a-form-model-item prop="moduleName">
            <span slot="label">
              生成模块名
              <a-tooltip>
                <template slot="title"> 可理解为子系统名，例如 system </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="12">
          <a-form-model-item prop="businessName">
            <span slot="label">
              生成业务名
              <a-tooltip>
                <template slot="title"> 可理解为功能英文名，例如 user </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="12">
          <a-form-model-item prop="functionName">
            <span slot="label">
              生成功能名
              <a-tooltip>
                <template slot="title"> 用作类描述，例如 用户 </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="12">
          <a-form-model-item>
            <span slot="label">
              生成代码方式
              <a-tooltip>
                <template slot="title"> 默认为zip压缩包下载，也可以自定义生成路径 </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="24" v-if="info.genType == '1'">
          ...
          >
            <span slot="label">
              自定义路径
              <a-tooltip>
                <template slot="title"> 填写磁盘绝对路径，若不填写，则生成到当前Web项目下 </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="12">
          <a-form-model-item>
            <span slot="label">
              树编码字段
              <a-tooltip>
                <template slot="title"> 树显示的编码字段名， 如：dept_id </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="12">
          <a-form-model-item>
            <span slot="label">
              树父编码字段
              <a-tooltip>
                <template slot="title"> 树显示的父编码字段名， 如：parent_Id </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="12">
          <a-form-model-item>
            <span slot="label">
              树名称字段
              <a-tooltip>
                <template slot="title"> 树节点的显示名称字段名， 如：dept_name </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="12">
          <a-form-model-item>
            <span slot="label">
              关联子表的表名
              <a-tooltip>
                <template slot="title"> 关联子表的表名， 如：sys_user </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
        ...
        <a-col :span="12">
          <a-form-model-item>
            <span slot="label">
              子表关联的外键名
              <a-tooltip>
                <template slot="title"> 子表关联的外键名， 如：user_id </template>
                <a-icon type="question-circle-o" />
              </a-tooltip>
            </span>
