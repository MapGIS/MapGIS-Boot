  ...
  methods: {
    ...
    renderTabPaneMenu(e, index) {
      return (
        ...
        >
          <a-menu-item disabled={index === 0} key="closeThat">
            关闭当前标签
          </a-menu-item>
          <a-menu-item disabled={this.pages.length === index + 1} key="closeRight">
            关闭右侧
          </a-menu-item>
          <a-menu-item disabled={index <= 1} key="closeLeft">
            关闭左侧
          </a-menu-item>
          <a-menu-item disabled={this.pages.length === 1} key="closeAll">
            关闭全部
          </a-menu-item>
        </a-menu>
      )
