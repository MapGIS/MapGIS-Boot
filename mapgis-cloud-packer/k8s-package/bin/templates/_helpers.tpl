...
{{- define "mapgis.imageMySQL" -}}
  {{- if .Values.imageMySQL -}}
    {{ .Values.imageMySQL }}
  {{- else -}}
    {{ include "mapgis.name" . }}-mysql:10.6.4.10
  {{- end -}}
{{- end -}}
...
{{- define "mapgis.imageGateway" -}}
  {{- if .Values.imageGateway -}}
    {{ .Values.imageGateway }}
  {{- else -}}
    {{ include "mapgis.name" . }}-gateway:10.6.4.10
  {{- end -}}
{{- end -}}
...
{{- define "mapgis.imageMonitor" -}}
  {{- if .Values.imageMonitor -}}
    {{ .Values.imageMonitor }}
  {{- else -}}
    {{ include "mapgis.name" . }}-monitor:10.6.4.10
  {{- end -}}
{{- end -}}
...
{{- define "mapgis.imageAuth" -}}
  {{- if .Values.imageAuth -}}
    {{ .Values.imageAuth }}
  {{- else -}}
    {{ include "mapgis.name" . }}-auth:10.6.4.10
  {{- end -}}
{{- end -}}
...
{{- define "mapgis.imageSystem" -}}
  {{- if .Values.imageSystem -}}
    {{ .Values.imageSystem }}
  {{- else -}}
    {{ include "mapgis.name" . }}-system:10.6.4.10
  {{- end -}}
{{- end -}}
...
{{- define "mapgis.imageFile" -}}
  {{- if .Values.imageFile -}}
    {{ .Values.imageFile }}
  {{- else -}}
    {{ include "mapgis.name" . }}-file:10.6.4.10
  {{- end -}}
{{- end -}}
...
{{- define "mapgis.imageJob" -}}
  {{- if .Values.imageJob -}}
    {{ .Values.imageJob }}
  {{- else -}}
    {{ include "mapgis.name" . }}-job:10.6.4.10
  {{- end -}}
{{- end -}}
...
{{- define "mapgis.imageGen" -}}
  {{- if .Values.imageGen -}}
    {{ .Values.imageGen }}
  {{- else -}}
    {{ include "mapgis.name" . }}-gen:10.6.4.10
  {{- end -}}
{{- end -}}
