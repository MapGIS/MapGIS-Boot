...
public class VelocityUtils {
    ...
    public static List<String> getTemplateList(String tplCategory) {
        ...
        if (GenConstants.TPL_CRUD.equals(tplCategory) || GenConstants.TPL_TREE.equals(tplCategory)) {
            ...
            templates.add("vm/vue/modules/CreateForm.vue.vm");
        } else if (GenConstants.TPL_SUB.equals(tplCategory)) {
            templates.add("vm/vue/index.vue.vm");
            templates.add("vm/vue/modules/CreateForm.vue.vm");
            templates.add("vm/vue/modules/SubTable.vue.vm");
            templates.add("vm/vue/modules/CreateSubForm.vue.vm");
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        if (template.contains("sub-domain.java.vm")
            ...
            fileName =
                    StringUtils.format("{}/views/{}/{}/modules/CreateSubForm.vue", vuePath, moduleName, businessName);
        }
        return fileName;
    }
