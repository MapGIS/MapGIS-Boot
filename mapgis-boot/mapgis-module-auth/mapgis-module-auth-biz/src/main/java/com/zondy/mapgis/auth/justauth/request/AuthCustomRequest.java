package com.zondy.mapgis.auth.justauth.request;

import com.alibaba.fastjson.JSONObject;
import com.zondy.mapgis.auth.justauth.source.AuthCustomSource;
...
public class AuthCustomRequest extends AuthDefaultRequest {
    ...
    public String authorize(String state) {
        return UrlBuilder.fromBaseUrl(super.authorize(state))
                .queryParam("scope", this.getScopes(" ", true, null))
                .build();
    }
}
