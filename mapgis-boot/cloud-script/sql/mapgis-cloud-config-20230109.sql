...
VALUES (1, 'mapgis-xxx-application-dev.yml', 'DEFAULT_GROUP',
        ...
        '0d6d4abb73fb2270ba351b7a0a27b376', '2022-03-31 00:00:00', '2023-01-09 06:07:11', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '通用配置', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
VALUES (2, 'mapgis-xxx-application-prod.yml', 'DEFAULT_GROUP',
        'spring:\n  autoconfigure:\n    exclude: com.alibaba.druid.spring.boot.autoconfigure.DruidDataSourceAutoConfigure\n  # 资源信息\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/messages\n  # jackson配置\n  jackson:\n    # 日期格式化\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n\n# feign 配置\nfeign:\n  sentinel:\n    enabled: true\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n  client:\n    config:\n      default:\n        connectTimeout: 10000\n        readTimeout: 10000\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n\n# 暴露监控端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\n\n# MyBatis Plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.zondy.mapgis.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/**/*Mapper.xml\n\n# Swagger配置\nswagger:\n  # 是否开启swagger\n  enabled: true\n  # 标题\n  title: MapGIS服务器产品 接口文档\n  # 描述\n  description: MapGIS服务器产品\n  gateway: http://${GATEWAY_PUBLIC_HOST:${mapgis.product.full-name}-gateway}:${GATEWAY_PUBLIC_PORT:8080}\n\n# SpringDoc配置\nspringdoc:\n  swagger-ui:\n    # 开启Swagger UI界面\n    enabled: ${swagger.enabled}\n\n# API前缀\napi:\n  path:\n    services-prefix: /${mapgis.product.name}/rest/services\n    manager-prefix: /${mapgis.product.name}/rest/manager\n\n# 安全配置\nsecurity:\n  # 访问\n  access:\n    # 只读开关\n    readonlyEnabled: false',
        '0d6d4abb73fb2270ba351b7a0a27b376', '2022-03-31 00:00:00', '2023-01-09 06:07:24', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '通用配置', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
VALUES (3, 'mapgis-xxx-gateway-server-dev.yml', 'DEFAULT_GROUP',
        ...
        '04aa832ac2b74a5b35bcccf11bfff011', '2022-03-31 00:00:00', '2022-12-29 09:38:07', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '网关模块', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
VALUES (4, 'mapgis-xxx-gateway-server-prod.yml', 'DEFAULT_GROUP',
        'spring:\n  redis:\n    host: ${REDIS_HOST:${mapgis.product.full-name}-redis}\n    port: ${REDIS_PORT:6379}\n    password: ${REDIS_PWD:cloud123.mapgis}\n  cloud:\n    gateway:\n      globalcors:\n        cors-configurations:\n          \'[/**]\':\n            allowedOriginPatterns: \"*\"\n            allowed-methods: \"*\"\n            allowed-headers: \"*\"\n            allow-credentials: true\n            exposedHeaders: \"Content-Disposition,Content-Type,Cache-Control\"\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n\n# 安全配置\nsecurity:\n  # 防止XSS攻击\n  xss:\n    # 过滤开关\n    enabled: true\n    # 排除链接\n    excludeUrls:\n      - ${api.path.manager-prefix}/system/notice\n  # 不校验白名单\n  ignore:\n    whites:\n      - ${api.path.manager-prefix}/system/webConfig/**\n      - ${api.path.manager-prefix}/auth/logout\n      - ${api.path.manager-prefix}/auth/login\n      - ${api.path.manager-prefix}/auth/register\n      - ${api.path.manager-prefix}/auth/captchaImage\n      - ${api.path.manager-prefix}/auth/isNeedCaptcha/**\n      - ${api.path.manager-prefix}/auth/thirdLogin/**\n      - ${api.path.manager-prefix}/auth/casLogin/**\n      - /${mapgis.product.name}/static/**\n      - /${mapgis.product.name}/manager/**\n      - /**/api-docs/**\n      - /csrf\n      - /',
        '04aa832ac2b74a5b35bcccf11bfff011', '2022-03-31 00:00:00', '2022-12-29 09:38:19', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '网关模块', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
...
VALUES (9, 'mapgis-xxx-system-server-dev.yml', 'DEFAULT_GROUP',
        ...
        '58b329bf0d7f6e0dfec68470a8934700', '2022-03-31 00:00:00', '2023-01-09 06:05:06', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '系统模块', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
VALUES (10, 'mapgis-xxx-system-server-prod.yml', 'DEFAULT_GROUP',
        '# spring配置\nspring: \n  redis:\n    host: ${REDIS_HOST:${mapgis.product.full-name}-redis}\n    port: ${REDIS_PORT:6379}\n    password: ${REDIS_PWD:cloud123.mapgis}\n  datasource:\n    druid:\n      stat-view-servlet:\n        enabled: true\n        loginUsername: admin\n        loginPassword: cloud123.mapgis\n    dynamic:\n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n          # 主库数据源\n          master:\n            driver-class-name: com.mysql.cj.jdbc.Driver\n            url: jdbc:mysql://${MYSQL_HOST:${mapgis.product.full-name}-mysql}:${MYSQL_PORT:3306}/${MYSQL_DB:mapgis-cloud-${mapgis.product.name}}?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n            username: ${MYSQL_USER:root}\n            password: ${MYSQL_PWD:cloud123.mapgis}\n          # HTTP访问日志库数据源\n          access_log:\n            driver-class-name: com.mysql.cj.jdbc.Driver\n            url: jdbc:mysql://${MYSQL_HOST:${mapgis.product.full-name}-mysql}:${MYSQL_PORT:3306}/mapgis-cloud-${mapgis.product.name}-access-log?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n            username: ${MYSQL_USER:root}\n            password: ${MYSQL_PWD:cloud123.mapgis}\n          # 硬件监控数据源\n          hardware_monitor:\n            driver-class-name: com.mysql.cj.jdbc.Driver\n            url: jdbc:mysql://${MYSQL_HOST:${mapgis.product.full-name}-mysql}:${MYSQL_PORT:3306}/mapgis-cloud-${mapgis.product.name}-hardware-monitor?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n            username: ${MYSQL_USER:root}\n            password: ${MYSQL_PWD:cloud123.mapgis}',
        '58b329bf0d7f6e0dfec68470a8934700', '2022-03-31 00:00:00', '2023-01-09 06:08:12', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '系统模块', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
VALUES (11, 'mapgis-xxx-job-server-dev.yml', 'DEFAULT_GROUP',
        '# spring配置\nspring: \n  redis:\n    host: ${REDIS_HOST:${mapgis.product.full-name}-redis}\n    port: ${REDIS_PORT:6379}\n    password: ${REDIS_PWD:cloud123.mapgis}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${MYSQL_HOST:${mapgis.product.full-name}-mysql}:${MYSQL_PORT:3306}/${MYSQL_DB:mapgis-cloud-${mapgis.product.name}}?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: ${MYSQL_USER:root}\n    password: ${MYSQL_PWD:cloud123.mapgis}',
        '81262c4c0bdc010606a7da00ebb2b7e9', '2022-03-31 00:00:00', '2023-01-09 06:08:37', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '定时任务', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
VALUES (12, 'mapgis-xxx-job-server-prod.yml', 'DEFAULT_GROUP',
        '# spring配置\nspring: \n  redis:\n    host: ${REDIS_HOST:${mapgis.product.full-name}-redis}\n    port: ${REDIS_PORT:6379}\n    password: ${REDIS_PWD:cloud123.mapgis}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${MYSQL_HOST:${mapgis.product.full-name}-mysql}:${MYSQL_PORT:3306}/${MYSQL_DB:mapgis-cloud-${mapgis.product.name}}?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: ${MYSQL_USER:root}\n    password: ${MYSQL_PWD:cloud123.mapgis}',
        '81262c4c0bdc010606a7da00ebb2b7e9', '2022-03-31 00:00:00', '2023-01-09 06:09:06', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '定时任务', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
...
VALUES (16, 'mapgis-xxx-gen-server-dev.yml', 'DEFAULT_GROUP',
        '# spring配置\nspring: \n  redis:\n    host: ${REDIS_HOST:${mapgis.product.full-name}-redis}\n    port: ${REDIS_PORT:6379}\n    password: ${REDIS_PWD:cloud123.mapgis}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${MYSQL_HOST:${mapgis.product.full-name}-mysql}:${MYSQL_PORT:3306}/${MYSQL_DB:mapgis-cloud-${mapgis.product.name}}?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: ${MYSQL_USER:root}\n    password: ${MYSQL_PWD:cloud123.mapgis}',
        '81262c4c0bdc010606a7da00ebb2b7e9', '2022-08-29 04:52:56', '2023-01-09 06:09:34', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '代码生成', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info`
VALUES (17, 'mapgis-xxx-gen-server-prod.yml', 'DEFAULT_GROUP',
        '# spring配置\nspring: \n  redis:\n    host: ${REDIS_HOST:${mapgis.product.full-name}-redis}\n    port: ${REDIS_PORT:6379}\n    password: ${REDIS_PWD:cloud123.mapgis}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${MYSQL_HOST:${mapgis.product.full-name}-mysql}:${MYSQL_PORT:3306}/${MYSQL_DB:mapgis-cloud-${mapgis.product.name}}?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: ${MYSQL_USER:root}\n    password: ${MYSQL_PWD:cloud123.mapgis}',
        '81262c4c0bdc010606a7da00ebb2b7e9', '2022-08-29 04:58:18', '2023-01-09 06:09:50', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '代码生成', 'null', 'null', 'yaml', '', '');
