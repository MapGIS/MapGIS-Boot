...
VALUES (1, '${mapgis.product.full-name}-auth-server', 'lb://${mapgis.product.full-name}-auth-server',
        '[{\"name\":\"Path\",\"args\":[\"${api.path.manager-prefix}/auth/**\"]}]',
...
INSERT INTO `sys_menu`
VALUES (115, '安全配置', 3, 1, 'securityConfig', 'security/config/index', NULL, 1, 0, 'C', '0', '0', 'system:config:query',
...
INSERT INTO `sys_menu`
VALUES (123, '日志配置', 2, 5, 'logConfig', 'log/config/index', NULL, 1, 0, 'C', '0', '0', 'system:config:query',
