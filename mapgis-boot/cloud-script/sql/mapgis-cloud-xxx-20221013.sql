...
VALUES (6, '开发扩展', 0, 6, 'tool', NULL, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', '2022-03-23 22:12:32', '', NULL,
        '开发扩展目录');
INSERT INTO `sys_menu`
VALUES (7, '系统设置', 0, 7, 'setting', NULL, '', 1, 0, 'M', '0', '0', '', 'setting', 'admin', '2022-10-11 18:33:09', '',
        NULL, '系统设置目录');
INSERT INTO `sys_menu`
...
INSERT INTO `sys_menu`
VALUES (106, '菜单管理', 3, 3, 'menu', 'system/menu/index', '', 1, 0, 'C', '0', '0', 'system:menu:list', 'treeTable',
...
VALUES (114, '微应用路由配置', 6, 4, 'microApp', 'system/microApp/index', '', 1, 0, 'C', '0', '0', 'system:microApp:list',
        'deployment-unit', 'admin', '2022-09-26 13:54:31', '', NULL, '微应用路由菜单配置');
INSERT INTO `sys_menu`
VALUES (115, '参数设置', 7, 1, 'config', 'system/config/index', '', 1, 0, 'C', '0', '0', 'system:config:list', 'edit',
        'admin', '2022-03-23 22:12:32', '', NULL, '参数设置菜单');
INSERT INTO `sys_menu`
VALUES (116, 'Sentinel控制台', 1, 2, 'http://localhost:8718', '', '', 0, 0, 'C', '0', '0', 'monitor:sentinel:list',
        'sentinel', 'admin', '2022-03-31 15:00:49', '', NULL, '流量控制菜单');
INSERT INTO `sys_menu`
VALUES (117, 'Nacos控制台', 1, 3, 'http://localhost:8848/nacos', '', '', 0, 0, 'C', '0', '0', 'monitor:nacos:list',
        'nacos', 'admin', '2022-03-31 15:00:49', '', NULL, '服务治理菜单');
INSERT INTO `sys_menu`
VALUES (118, 'Admin控制台', 1, 4, 'http://localhost:9200/login', '', '', 0, 0, 'C', '0', '0', 'monitor:server:list',
        'server', 'admin', '2022-03-31 15:00:49', '', NULL, '服务监控菜单');
INSERT INTO `sys_menu`
VALUES (119, '微服务路由配置', 6, 5, 'route', 'system/route/index', '', 1, 0, 'C', '0', '0', 'system:route:list', 'route',
...
VALUES (1060, '微应用路由导出', 114, 5, '#', '', '', 1, 0, 'F', '0', '0', 'system:microApp:export', '#', 'admin',
        '2022-09-26 13:54:31', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1061, '参数查询', 115, 1, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:query', '#', 'admin',
        '2022-03-23 22:12:32', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1062, '参数新增', 115, 2, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:add', '#', 'admin',
        '2022-03-23 22:12:32', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1063, '参数修改', 115, 3, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:edit', '#', 'admin',
        '2022-03-23 22:12:32', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1064, '参数删除', 115, 4, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:remove', '#', 'admin',
        '2022-03-23 22:12:32', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1065, '参数导出', 115, 5, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:export', '#', 'admin',
        '2022-03-23 22:12:32', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1066, '网关路由查询', 119, 1, '#', '', '', 1, 0, 'F', '0', '0', 'system:route:query', '#', 'admin',
        '2022-09-21 22:08:36', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1067, '网关路由新增', 119, 2, '#', '', '', 1, 0, 'F', '0', '0', 'system:route:add', '#', 'admin',
        '2022-09-21 22:08:36', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1068, '网关路由修改', 119, 3, '#', '', '', 1, 0, 'F', '0', '0', 'system:route:edit', '#', 'admin',
        '2022-09-21 22:08:36', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1069, '网关路由删除', 119, 4, '#', '', '', 1, 0, 'F', '0', '0', 'system:route:remove', '#', 'admin',
        '2022-09-21 22:08:36', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (1070, '网关路由导出', 119, 5, '#', '', '', 1, 0, 'F', '0', '0', 'system:route:export', '#', 'admin',
        '2022-09-21 22:08:36', '', NULL, '');
