...
VALUES (3, 'mapgis-xxx-gateway-server-dev.yml', 'DEFAULT_GROUP',
        ...
        '5060b5bb33ae6c52477f5b1eca412ab6', '2022-03-31 00:00:00', '2022-05-19 02:48:50', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '网关模块', 'null', 'null', 'yaml', 'null');
INSERT INTO `config_info`
VALUES (4, 'mapgis-xxx-gateway-server-prod.yml', 'DEFAULT_GROUP',
        'spring:\n  redis:\n    host: localhost\n    port: 6379\n    password: \n  cloud:\n    gateway:\n      globalcors:\n        cors-configurations:\n          \'[/**]\':\n            allowedOriginPatterns: \"*\"\n            allowed-methods: \"*\"\n            allowed-headers: \"*\"\n            allow-credentials: true\n            exposedHeaders: \"Content-Disposition,Content-Type,Cache-Control\"\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: mapgis-xxx-auth-server\n          uri: lb://mapgis-xxx-auth-server\n          predicates:\n            - Path=/xxx/rest/services/auth/**\n          filters:\n            # 验证码处理\n            - CacheRequestFilter\n            - ValidateCodeFilter\n        # 定时任务\n        - id: mapgis-xxx-job-server\n          uri: lb://mapgis-xxx-job-server\n          predicates:\n            - Path=/xxx/rest/manager/schedule/**\n          filters:\n        # 系统模块\n        - id: mapgis-xxx-system-server\n          uri: lb://mapgis-xxx-system-server\n          predicates:\n            - Path=/xxx/rest/manager/system/**\n          filters:\n        # 文件服务\n        - id: mapgis-xxx-file-server\n          uri: lb://mapgis-xxx-file-server\n          predicates:\n            - Path=/xxx/rest/manager/file/**\n          filters:\n        # openapi\n        - id: openapi\n          uri: http://localhost:${server.port}\n          predicates:\n            - Path=/v3/api-docs/**\n          filters:\n            - RewritePath=/v3/api-docs/(?<path>.*),/$\\{path}/v3/api-docs\n\n# SpringDoc配置\nspringdoc:\n  swagger-ui:\n    use-root-path: true\n\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: true\n    # 验证码类型 math 数组计算 char 字符验证\n    type: math\n  # 防止XSS攻击\n  xss:\n    # 过滤开关\n    enabled: true\n    # 排除链接\n    excludeUrls:\n      - /xxx/rest/manager/system/notice\n  # 不校验白名单\n  ignore:\n    whites:\n      - /xxx/rest/services/auth/logout\n      - /xxx/rest/services/auth/login\n      - /xxx/rest/services/auth/register\n      - /**/api-docs/**\n      - /csrf',
        '5060b5bb33ae6c52477f5b1eca412ab6', '2022-03-31 00:00:00', '2022-05-19 02:50:43', 'nacos', '0:0:0:0:0:0:0:1',
        '', '', '网关模块', 'null', 'null', 'yaml', 'null');
INSERT INTO `config_info`
