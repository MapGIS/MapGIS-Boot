...
VALUES (1, '监控管理', 0, 1, 'monitor', NULL, '', 1, 0, 'M', 0, 0, '', 'monitor', 'admin', '2022-03-23 22:12:32', '', NULL, '监控管理目录');
INSERT INTO "sys_menu"
...
VALUES (3, '安全管理', 0, 3, 'security', NULL, '', 1, 0, 'M', 0, 0, '', 'safety-certificate', 'admin', '2022-03-23 22:12:32', '', NULL,
        '安全管理目录');
INSERT INTO "sys_menu"
VALUES (4, '计划任务', 0, 4, 'schedule', NULL, '', 1, 0, 'M', 0, 0, '', 'job', 'admin', '2022-10-11 14:20:47', '', NULL, '定时任务目录');
INSERT INTO "sys_menu"
VALUES (5, '消息中心', 0, 5, 'message', NULL, '', 1, 0, 'M', 0, 0, '', 'bell', 'admin', '2022-10-12 08:56:41', '', NULL, '消息中心目录');
INSERT INTO "sys_menu"
VALUES (6, '开发扩展', 0, 6, 'dev', NULL, '', 1, 0, 'M', 0, 0, '', 'tool', 'admin', '2022-03-23 22:12:32', '', NULL, '开发扩展目录');
INSERT INTO "sys_menu"
VALUES (7, '系统配置', 0, 7, 'config', NULL, '', 1, 0, 'M', 0, 0, '', 'setting', 'admin', '2022-10-11 18:33:09', '', NULL, '系统设置目录');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (104, '用户管理', 3, 2, 'user', 'system/user/index', '', 1, 0, 'C', 0, 0, 'system:user:list', 'user', 'admin', '2022-03-23 22:12:32',
        '', NULL, '用户管理菜单');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (107, '部门管理', 3, 6, 'dept', 'system/dept/index', '', 1, 0, 'C', 0, 0, 'system:dept:list', 'tree', 'admin', '2022-03-23 22:12:32',
        '', NULL, '部门管理菜单');
INSERT INTO "sys_menu"
VALUES (108, '岗位管理', 3, 7, 'post', 'system/post/index', '', 1, 0, 'C', 0, 0, 'system:post:list', 'post', 'admin', '2022-03-23 22:12:32',
        '', NULL, '岗位管理菜单');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (112, '数据字典', 6, 2, 'dict', 'system/dict/index', '', 1, 0, 'C', 0, 0, 'system:dict:list', 'dict', 'admin', '2022-03-23 22:12:32',
        '', NULL, '字典管理菜单');
INSERT INTO "sys_menu"
VALUES (113, '代码生成', 6, 3, 'gen', 'tool/gen/index', '', 1, 0, 'C', 0, 0, 'tool:gen:list', 'code', 'admin', '2022-03-23 22:12:32', '',
        NULL, '代码生成菜单');
INSERT INTO "sys_menu"
VALUES (114, '微应用路由配置', 6, 4, 'microApp', 'system/microApp/index', '', 1, 0, 'C', 0, 0, 'system:microApp:list', 'deployment-unit',
        'admin', '2022-09-26 13:54:31', '', NULL, '微应用路由配置菜单');
INSERT INTO "sys_menu"
VALUES (115, '安全配置', 3, 1, 'securityConfig', 'security/config/index', '', 1, 0, 'C', 0, 0, 'system:config:query', 'validCode', 'admin',
        '2022-10-14 17:51:53', '', NULL, '安全配置菜单');
INSERT INTO "sys_menu"
VALUES (116, '基本配置', 7, 1, 'base', 'config/base/index', '', 1, 0, 'C', 0, 0, 'system:config:query', 'profile', 'admin',
        '2022-10-15 15:45:11', '', NULL, '基本配置菜单');
INSERT INTO "sys_menu"
VALUES (117, '第三方登录配置', 3, 8, 'oauth', 'security/authConfig/index', NULL, 1, 0, 'C', 0, 0, 'system:authConfig:list', 'security-scan',
        'admin', '2022-10-21 16:11:18', '', NULL, '第三方登录配置菜单');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (119, '主题配置', 7, 2, 'theme', 'config/theme/index', NULL, 1, 0, 'C', 0, 0, '', 'skin', 'admin', '2022-10-31 11:39:51', '', NULL,
        '主题配置菜单');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (122, '服务访问日志', 2, 4, 'assesslog', 'log/assesslog/index', NULL, 1, 1, 'C', 0, 0, 'system:assesslog:list', 'file-text', 'admin',
        '2022-11-28 17:23:54', '', NULL, '服务访问日志菜单');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (124, '服务器性能监控', 1, 3, 'performance', 'monitor/performance/index', NULL, 1, 1, 'C', 0, 0, 'monitor:serverPerformance:list',
        'fund', 'admin', '2022-12-06 10:54:54', '', NULL, '服务器性能监控菜单');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (1001, '批量强退', 100, 2, '', '', '', 1, 0, 'F', 0, 0, 'monitor:online:batchLogout', '#', 'admin', '2022-03-23 22:12:32', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1002, '单条强退', 100, 3, '', '', '', 1, 0, 'F', 0, 0, 'monitor:online:forceLogout', '#', 'admin', '2022-03-23 22:12:32', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1003, '登录查询', 102, 1, '', '', '', 1, 0, 'F', 0, 0, 'system:logininfor:query', '#', 'admin', '2022-03-23 22:12:32', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1004, '登录删除', 102, 2, '', '', '', 1, 0, 'F', 0, 0, 'system:logininfor:remove', '#', 'admin', '2022-03-23 22:12:32', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1005, '日志导出', 102, 3, '', '', '', 1, 0, 'F', 0, 0, 'system:logininfor:export', '#', 'admin', '2022-03-23 22:12:32', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1006, '账号解锁', 102, 4, '', '', '', 1, 0, 'F', 0, 0, 'system:logininfor:unlock', '#', 'admin', '2022-08-15 22:12:32', '', NULL,
        '');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (1039, '状态修改', 109, 5, '', '', '', 1, 0, 'F', 0, 0, 'monitor:job:changeStatus', '#', 'admin', '2022-03-23 22:12:32', '', NULL,
        '');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (1056, '微应用路由查询', 114, 1, '', '', '', 1, 0, 'F', 0, 0, 'system:microApp:query', '#', 'admin', '2022-09-26 13:54:31', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1057, '微应用路由新增', 114, 2, '', '', '', 1, 0, 'F', 0, 0, 'system:microApp:add', '#', 'admin', '2022-09-26 13:54:31', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1058, '微应用路由修改', 114, 3, '', '', '', 1, 0, 'F', 0, 0, 'system:microApp:edit', '#', 'admin', '2022-09-26 13:54:31', '', NULL,
        '');
INSERT INTO "sys_menu"
...
VALUES (1065, '第三方登录配置修改', 117, 3, '', '', '', 1, 0, 'F', 0, 0, 'system:authConfig:edit', '#', 'admin', '2022-10-21 16:11:18', '',
        NULL, '');
INSERT INTO "sys_menu"
VALUES (1066, '第三方登录配置删除', 117, 4, '', '', '', 1, 0, 'F', 0, 0, 'system:authConfig:remove', '#', 'admin', '2022-10-21 16:11:18',
        '', NULL, '');
INSERT INTO "sys_menu"
VALUES (1067, '第三方登录配置导出', 117, 5, '', '', '', 1, 0, 'F', 0, 0, 'system:authConfig:export', '#', 'admin', '2022-10-21 16:11:18',
        '', NULL, '');
INSERT INTO "sys_menu"
...
INSERT INTO "sys_menu"
VALUES (1075, '用户组查询', 125, 1, '', '', '', 1, 0, 'F', 0, 0, 'system:usergroup:query', '#', 'admin', '2022-12-23 16:32:50', '', NULL,
        '');
INSERT INTO "sys_menu"
...
VALUES (1077, '用户组修改', 125, 3, '', '', '', 1, 0, 'F', 0, 0, 'system:usergroup:edit', '#', 'admin', '2022-12-23 16:32:50', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1078, '用户组删除', 125, 4, '', '', '', 1, 0, 'F', 0, 0, 'system:usergroup:remove', '#', 'admin', '2022-12-23 16:32:50', '', NULL,
        '');
INSERT INTO "sys_menu"
VALUES (1079, '用户组导出', 125, 5, '', '', '', 1, 0, 'F', 0, 0, 'system:usergroup:export', '#', 'admin', '2022-12-23 16:32:50', '', NULL,
        '');
